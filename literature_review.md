...
The MOGRN structural analysis of the microbial opsin family represents a significant step forward in mapping the functional landscape of these remarkable molecular machines. Our updated analysis encompasses 129 structures (all predicted using state-of-the-art computational methods), providing a comprehensive view of the structural diversity within this protein family. This dataset captures the major functional categories with the following distribution: Proton Pumps (42 structures, 32.6%), Cation Channels (28 structures, 21.7%), Sensor/Regulatory proteins (22 structures, 17.1%), and smaller representations of Anion Channels (12, 9.3%), Chloride Pumps (12, 9.3%), Sodium Pumps (6, 4.7%), and Unknown functions (7, 5.4%). The phylogenetic distribution spans Eukaryota (50 structures, 38.8%), Bacteria (42, 32.6%), Archaea (27, 20.9%), and includes representatives from Synthetic constructs (5, 3.9%) and Viruses (5, 3.9%). This approach is emblematic of a paradigm shift in modern structural biology, where computational methods are no longer merely adjuncts to experimental techniques but are indispensable tools for navigating the vast, uncharted territories of protein sequence space.1 The resulting dataset provides a far more comprehensive, albeit still incomplete, view of the opsin superfamily.
