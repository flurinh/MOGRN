...
Generated on: 2025-06-20 12:29:52
...
- **Natural functions**: 6 (excluding Unknown)
- **Natural domains**: 4 (excluding Synthetic)
- **Natural function-domain combinations observed**: 14
- **Theoretical natural combinations**: 24 (6 functions × 4 domains)
- **Natural combination coverage**: 58.3%
